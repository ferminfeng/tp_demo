...
class WbShare
{
    ...
    {
        $this->client_id = $this->getConfigData()['wb_app_id'];
        $this->client_secret = $this->getConfigData()['wb_app_secret'];
    ...
    function getTicketURL($url)
    {
        $params['client_id'] = $this->client_id;
        $params['client_secret'] = $this->client_secret;

        //先读取文件，如果有则从文件取出，否则请求
